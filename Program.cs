...
namespace CosmosDBQuickStart {
    class Program {
        ...
        //https://cosmosprateek-sqlapi.documents.azure.com:443/

//UYcPDNzyLMdxtu477BqXK9Euoy9QDW63OXcDyzoKnf5RA6FDBnOzVkWupjkmlirRfZDAIRtoLPsomDNwOh7YpQ==
        private const string EndpointUrl = "https://cosmosprateek-sqlapi.documents.azure.com:443/";
        private const string AuthorizationKey = "UYcPDNzyLMdxtu477BqXK9Euoy9QDW63OXcDyzoKnf5RA6FDBnOzVkWupjkmlirRfZDAIRtoLPsomDNwOh7YpQ==";
        ...
        private static async Task QueryItemsAsync (CosmosClient cosmosClient) {
            ...
            await
            foreach (Family family in container.GetItemQueryIterator<Family> (queryDefinition)) {
                families.Add (family);
